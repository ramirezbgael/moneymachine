      ...
      <div className="modal barcode-print-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal__content">
          ...
          <p className="barcode-print-modal__hint">
            Elige los productos y se imprimirán en la impresora configurada en Configuración → Impresora (misma que los tickets). Una etiqueta por producto.
          </p>
          {printerName && (printerName.toLowerCase().includes('text only') || printerName.toLowerCase().includes('generic')) && (
            <p className="barcode-print-modal__error" style={{ marginTop: 8 }}>
              Impresora &quot;Solo texto&quot;: se imprimirá el nombre y el código como texto. Para códigos de barras reales, en Windows agrega la impresora con controlador <strong>Raw</strong> o el driver de tu térmica.
            </p>
          )}
          <input
            type="text"
