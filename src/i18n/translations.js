...
export const translations = {
  en: {
    ...
    currentSale: {
      ...
      pendingModalTitle: 'Saved as pending',
      pendingModalSubtitle: 'The cart was cleared. You can charge this sale later from Pending sales.',
      pendingPrintQuestion: 'Print ticket?',
      pendingPrintYes: 'Yes, print',
      pendingPrintNo: 'No thanks',
      pendingPrinting: 'Sending to printer…',
      pendingPrintSent: 'Ticket sent to printer.',
      pendingPrintError: 'Could not print. Check the printer and try again from Pending sales.',
      pendingBrowserHint: 'Thermal printing is only available in the desktop app. Copy the text below or print from your browser.',
      pendingCopyTicket: 'Copy ticket',
      pendingCopied: 'Copied',
      pendingCopyError: 'Could not copy',
      pendingContinue: 'Continue',
      pendingTicketPayment: 'PENDING',
      quotationCode: 'Quotation Code',
      scanToLoad: 'Scan this code to load products quickly',
      posTabProducts: 'Products',
      posTabCart: 'Cart',
      posOpenMenu: 'Open menu',
      posTabsAria: 'Switch between products and cart',
      posCatalogSection: 'Catalog',
      posQuickSection: 'Quick add',
      cajaNav: 'Register'
    },
    // Payment Modal
    payment: {
  ...
  es: {
    ...
    currentSale: {
      ...
      pendingModalTitle: 'Guardada como pendiente',
      pendingModalSubtitle: 'Se vació el carrito. Puedes cobrar esta venta después desde Ventas pendientes.',
      pendingPrintQuestion: '¿Imprimir ticket?',
      pendingPrintYes: 'Sí, imprimir',
      pendingPrintNo: 'No, gracias',
      pendingPrinting: 'Enviando a la impresora…',
      pendingPrintSent: 'Ticket enviado a la impresora.',
      pendingPrintError: 'No se pudo imprimir. Revisa la impresora o imprime desde Ventas pendientes.',
      pendingBrowserHint: 'La impresión térmica solo está disponible en la app de escritorio. Copia el texto o imprime desde el navegador.',
      pendingCopyTicket: 'Copiar ticket',
      pendingCopied: 'Copiado',
      pendingCopyError: 'No se pudo copiar',
      pendingContinue: 'Continuar',
      pendingTicketPayment: 'PENDIENTE',
      quotationCode: 'Código de Cotización',
      scanToLoad: 'Escanee este código para cargar productos rápidamente',
      posTabProducts: 'Productos',
      posTabCart: 'Carrito',
      posOpenMenu: 'Abrir menú',
      posTabsAria: 'Cambiar entre productos y carrito',
      posCatalogSection: 'Catálogo',
      posQuickSection: 'Rápidos',
      cajaNav: 'Caja'
    },
    // Modal de Pago
    payment: {
